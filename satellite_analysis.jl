...
# ╔═╡ e79f0050-c77e-11ec-02f8-bd938af88ec0
begin
	using CSV
	using DataFrames
	using GeoDataFrames
...
# ╔═╡ cfa1fd2b-1c86-45a6-beea-1128469b94f8
begin
	data_base = joinpath(pwd(), "data","nyc","satellite")
	lst_path = joinpath(data_base, "lst.csv")
	elv_path = joinpath(data_base, "elevation.csv")
	veg_path = joinpath(data_base, "sentinel.csv")
end

# ╔═╡ 43c8fe11-3189-4f28-9f4b-5cfd4771f88b
begin
	sentinel = DataFrame(CSV.File(veg_path))
	sentinel.date = Dates.DateTime.(sentinel.date, dateformat"yyyy-mm-dd HH:MM:SS")
	sentinel.time = Dates.Time.(sentinel.date)
	sentinel
	# lst_values = dropmissing(lst, [:dates, :LST_Night_1km])
	# lst_night = lst_values.LST_Night_1km
	# lst_dates = lst_values.date
end

# ╔═╡ 1634806f-ed83-46f6-ae86-11da47b53e7a
unique(sentinel.id)

# ╔═╡ ed46dfdb-f048-4148-a230-e3916e5d0366
single_point = sentinel[sentinel[:,:id] .== "0859f", :]

# ╔═╡ c53bef14-b111-4665-ac86-bec098ebd9a5
Plots.scatter(
	single_point.date,
	single_point.ndvi,
	color="indianred"
...
# ╔═╡ 3f802320-ff3e-405d-8928-032241931b80


# ╔═╡ 470e776d-f693-4c3d-b5ba-ee076315b404


# ╔═╡ ac8f376e-f171-474e-9d30-4326dd0ddb51
lst_values

# ╔═╡ 45364b38-eab4-4cb5-9d20-1c677fffd662


# ╔═╡ dba02e8b-4255-4bc4-8c72-4e55795e105c
...
git-tree-sha1 = "805bec326c2e33cacc29e041d024be960a653ca5"
...
git-tree-sha1 = "7e3a8d205fd4488f9faeead36cb7cdd2bb0547bc"
